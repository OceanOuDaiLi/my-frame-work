...
public static class PathHelper
{
    ...
    public static void EnsureExistFileDirectory(string file)
    {
        try
        {
            ...
            {
                UnityEngine.Debug.Log($"[PathUtility]EnsureExistFileDirectory:{file} dirname is null");
                return;
            }
        ...
        {
            UnityEngine.Debug.Log($"[PathUtility]EnsureExistFileDirectory:{file}");
    ...
    public static void EnsureNotExistFileDirectory(string file)
    {
        ...
        if (string.IsNullOrEmpty(dirName))
        {
            UnityEngine.Debug.Log($"[PathUtility]EnsureNotExistFileDirectory:{file} dirname is null");
            return;
        }
