...
namespace ET
{
    ...
    public class KChannel : AChannel
    {
        ...
        public KChannel(long id, uint localConn, Socket socket, IPEndPoint remoteEndPoint, KService kService)
        {
            ...
            SDebug.Info($"channel create: {this.Id} {this.LocalConn} {remoteEndPoint} {this.ChannelType}");
        ...
        public KChannel(long id, uint localConn, uint remoteConn, Socket socket, IPEndPoint remoteEndPoint, KService kService)
        {
            ...
            SDebug.Info($"channel create: {this.Id} {localConn} {remoteConn} {remoteEndPoint} {this.ChannelType}");
        ...
        public override void Dispose()
        {
            ...
            SDebug.Info($"channel dispose: {this.Id} {localConn} {remoteConn}");
        ...
        public void HandleConnnect()
        {
            ...
            SDebug.Info($"channel connected: {this.Id} {this.LocalConn} {this.RemoteConn} {this.RemoteAddress}");
        ...
        private void Connect()
        {
            try
            {
                ...
                SDebug.Info($"kchannel connect {this.Id} {this.LocalConn} {this.RemoteConn} {this.RealAddress} {this.socket.LocalEndPoint}");
