...
namespace ET
{
    ...
    public sealed class TChannel : AChannel
    {
        ...
        public override void Dispose()
        {
            ...
            SDebug.Info($"channel dispose: {this.Id} {this.RemoteAddress}");
        ...
        private void StartRecv()
        {
            while (true)
            {
                ...
                {
                    SDebug.LogError($"tchannel error: {this.Id}\n{e}");
        ...
        private void HandleRecv(object o)
        {
            ...
            while (true)
            {
                ...
                {
                    SDebug.LogError($"ip: {this.RemoteAddress} {ee}");
        ...
        private void OnRead(MemoryStream memoryStream)
        {
            ...
            {
                SDebug.LogError($"{this.RemoteAddress} {memoryStream.Length} {e}");
        ...
        {
            SDebug.Info($"TChannel OnError: {error} {this.RemoteAddress}");
