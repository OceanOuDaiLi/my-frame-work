...
namespace Goap.AI
{
    public class GoapAIGoalNode : GoapAIBaseNode
    {
        public delegate void GoalNodeDelegate(GoapAIGoalNode aNode);
        ...
        private GoapAIScenarioGoal _goal;
        ...
        public GoapAIScenarioGoal Goal
        {
            get 
            {
                return _goal; 
        ...
        public override string Title
        {
            get
            {
                return string.Format(title, _goal.name);
            }
        }
        ...
        public GoapAIGoalNode(Vector2 aPosition, float aWidth, float aHeight,
        ...
        private void DrawConditionList(string aLabel, ref GoapAIScenarioItem[] aConditions)
        {
        ...
        private void OnAddCondition(object aValue)
        {
            ...
            GoapArray.Add(ref _goal.conditions, item);
        }
