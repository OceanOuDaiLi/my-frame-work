...
namespace ET
{
    ...
    public sealed class TChannel : AChannel
    {
        ...
        public override void Dispose()
        {
            ...
            EDebug.Log($"channel dispose: {this.Id} {this.RemoteAddress}");
        ...
        private void StartRecv()
        {
            while (true)
            {
                ...
                {
                    EDebug.LogError($"tchannel error: {this.Id}\n{e}");
        ...
        private void HandleRecv(object o)
        {
            ...
            while (true)
            {
                ...
                {
                    EDebug.LogError($"ip: {this.RemoteAddress} {ee}");
        ...
        private void OnRead(MemoryStream memoryStream)
        {
            ...
            {
                EDebug.LogError($"{this.RemoteAddress} {memoryStream.Length} {e}");
        ...
        {
            EDebug.Log($"TChannel OnError: {error} {this.RemoteAddress}");
