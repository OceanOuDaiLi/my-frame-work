...
namespace Core.Hash
{
    ...
    public class Hash : IHash
    {
        ...
        /// <summary>
        /// 用于计算文件的md5，不应该用它进行密码等高敏感的hash加密
        /// </summary>
        ...
        /// <summary>
        /// 用于计算二进制byte的md5，不应该用它进行密码等高敏感的hash加密
        /// </summary>
        /// <param name="bytes">二进制byte</param>
        /// <returns>md5加密的值</returns>
        public string ByteMd5(byte[] bytes)
        {
            return Md5.ParseByte(bytes);
        }

        /// <summary>
        /// 字符串md5，不应该用它进行密码等高敏感的hash加密
        /// </summary>
