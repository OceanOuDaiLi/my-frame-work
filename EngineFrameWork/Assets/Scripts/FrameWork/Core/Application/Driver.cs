...
namespace Core
{
    ...
    /// Application行为驱动器
    /// </summary>
    public class Driver : IEventImpl
    {
        /// <summary>
        /// 主线程调度队列锁
        /// </summary>
        ...
        {
            get { return eventImpl ?? (eventImpl = new EventImpl()); }
        }
        ...
        public void StopCoroutine(Coroutine coroutine) {
            ...
            Guard.Requires<ArgumentNullException>(coroutine != null);
            driverBehaviour.StopCoroutine(coroutine);
        }
