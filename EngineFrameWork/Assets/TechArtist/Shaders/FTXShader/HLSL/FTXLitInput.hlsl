#ifndef UNIVERSAL_FTX_LIT_INPUT_INCLUDED
#define UNIVERSAL_FTX_LIT_INPUT_INCLUDED
...
inline void InitializeStandardLitSurfaceData(half4 uv, out FTXSurfaceData outFTXSurfaceData)
{
#ifndef _USEUV3_OFF
    ...
    outFTXSurfaceData.emission = SampleEmission(uv, _EmissionColor.rgb, TEXTURE2D_ARGS(_EmissionMap, sampler_EmissionMap));

#if defined(_DETAIL)
    half detailMask = SAMPLE_TEXTURE2D(_DetailMask, sampler_DetailMask, uv).a;
    float2 detailUv = uv * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
    outFTXSurfaceData.albedo = ApplyDetailAlbedo(detailUv, outFTXSurfaceData.albedo, detailMask);
    outFTXSurfaceData.normalTS = ApplyDetailNormal(detailUv, outFTXSurfaceData.normalTS, detailMask);
#endif
}
