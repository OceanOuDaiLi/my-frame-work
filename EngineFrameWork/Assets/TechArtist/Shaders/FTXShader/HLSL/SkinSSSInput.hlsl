...
inline void InitializeStandardLitSurfaceData(float2 uv, out SkinSurfaceData outSkinSurfaceData)
{
    ...
    outSkinSurfaceData.alpha = albedoAlpha.a * _BaseColor.a;
    ...
    outSkinSurfaceData.curvature = specGloss.b;
...
half3 CalculateSSSTerm(half NdotL, half curvature)
{
    half3 sssTerm = SAMPLE_SSSLUTMAP(half2((NdotL * 0.5 + 0.5), _SSSFactor * curvature)).rgb;
