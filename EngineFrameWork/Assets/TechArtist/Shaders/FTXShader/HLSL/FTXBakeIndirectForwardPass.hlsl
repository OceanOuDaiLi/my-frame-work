...
half4 LitPassFragment(Varyings input) : SV_Target
{
    ...
    half4 texColor2 = SAMPLE_TEXTURE2D(_Base2Map, sampler_Base2Map, uv2);
    half alpha = texColor.a * _BaseColor.a;
    half alpha2 = texColor2.a * _Base2Color.a;
    half3 color = texColor.rgb * _BaseColor.rgb * (1 - alpha2) + texColor2.rgb * _Base2Color.rgb * alpha2;
#else
    half4 texColor = SAMPLE_TEXTURE2D(_BaseMap, sampler_BaseMap, uv);
