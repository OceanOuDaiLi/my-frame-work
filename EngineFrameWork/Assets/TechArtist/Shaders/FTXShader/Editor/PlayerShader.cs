...
namespace UnityEditor.Rendering.Universal.ShaderGUI
{
    internal class PlayerShader : BaseShaderGUI
    {
        ...
        private MaterialProperty mainLightCompensation = new MaterialProperty();
        ...
        public override void FindProperties(MaterialProperty[] properties)
        {
            ...
            mainLightCompensation = FindProperty("_MainLightCompensation", properties, false);
        }
        ...
        public override void DrawSurfaceInputs(Material material)
        {
            ...
            materialEditor.RangeProperty(mainLightCompensation, "Main Light Compensation");
