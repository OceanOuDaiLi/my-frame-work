...
namespace UnityEditor.Rendering.Universal.ShaderGUI
{
    internal class SkinSSSShader : BaseShaderGUI
    {
        ...
        private MaterialProperty specularHighlightIntensityProp = new MaterialProperty();
        ...
        public override void FindProperties(MaterialProperty[] properties)
        {
            ...
            specularHighlightIntensityProp = FindProperty("_SpecularHighlightIntensity", properties, false);            
        }
        ...
        public override void DrawAdvancedOptions(Material material)
        {
            if (litProperties.reflections != null && litProperties.highlights != null)
            {
                ...
                if(litProperties.highlights.floatValue == 1)
                {
                    materialEditor.RangeProperty(specularHighlightIntensityProp, "Specular Highlight Intensity");
                }
