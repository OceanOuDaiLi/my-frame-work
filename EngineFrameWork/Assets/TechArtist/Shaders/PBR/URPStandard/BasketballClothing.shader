Shader "NBA2/URP/BasketballClothing"
{
	Properties
	{
		_AlbedoMap("", 2D) = "white" {}
		...
		_BSSRDFMap("", 2D) = "white"{}
		_MetallicMap("", 2D) = "white" {}    //_ThicknessMap
		_TranslucencyColor("", Color) = (1, 0, 0, 1)
		_ThicknessAndCurvature("", Vector) = (2.5, 5, 0.4, 1)

		_ThicknessScale("", Range(0, 2)) = 1
		_ThicknessPower("", Range(0, 5)) = 1
		_CurvaturePower("", Range(0, 5)) = 1
		_CurvatureScale("", Range(0, 2)) = 1
		...
		_AOIntensity("", Range(0,1)) = 1
			...
			_SkinShadowColor("", Color) = (0,0,0,1)
			...
			_DetailBumpScale("", Range(0, 2)) = 1
				...
				_SweatMap("", 2D) = "Black"{}
				_SweatBumpScale("", Range(0, 2)) = 1
				_SweatSmoothnessScale("", Range(0, 2)) = 1
				_SweatSwitch("", Range(0, 1)) = 1
		...
		SubShader
				{
					...
					#pragma shader_feature NUMTEX_ON
					...
					#include "BasketballClothing.hlsl"
					ENDHLSL
				}
