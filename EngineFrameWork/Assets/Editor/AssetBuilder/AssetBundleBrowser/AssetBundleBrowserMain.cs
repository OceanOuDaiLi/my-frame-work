...
namespace AssetBundleBrowser
{
    public class AssetBundleBrowserMain : EditorWindow, IHasCustomMenu, ISerializationCallbackReceiver
    {
        ...
        public static AssetBundleBrowserMain s_instance = null;
        ...
        void ModeToggle()
        {
            ...
            switch (m_Mode)
            {
                case Mode.Browser:
                    ...
                    if (clicked)
                    {
                        TipsAlertWindow.ShowAlertWithBtn("### FBI Warning ###", "刷新将重新构建AssetBundle标识，\n" +
                            "清空已构建资源， \n严禁在构建机执行此操作 \n是否继续？ \n" + "tips: 可在左侧预览面板，右键ReloadAllData，加载最新AB标识的资源  \n",
                            () =>
                        {
            ...
            string[] labels = new string[2] { "AssetBundle 预览", "AssetBundle 构建" };
