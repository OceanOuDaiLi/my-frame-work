...
public class ExcelTools : EditorWindow
{
    ...
    [MenuItem("公共工具/配置转表/JSON | LUA | CSV | XML", false, priority = 840)]
    ...
    [MenuItem("公共工具/配置转表/Luban | To | Json", false, priority = 800)]
    static void ExcelToolsLubanToJson()
    {
        string exportCfgPath = "Editor/ExcelTools/Luban/Luban_ToJson.asset";
        UnityEngine.Object _asset = AssetDatabase.LoadAssetAtPath(App.Env.AssetPath.Substring(App.Env.AssetPath.IndexOf("Assets"))
            ...
            + exportCfgPath, typeof(UnityEngine.Object));


        Debug.Log(exportCfgPath);
        Debug.Log(_asset == null);

        LubanExportConfig cfg = (LubanExportConfig)_asset;
        cfg.Gen();
    }

    [MenuItem("公共工具/配置转表/Luban | To | Protobuf", false, priority = 820)]
    static void ExcelToolsLubanToProtobuf()
    {
