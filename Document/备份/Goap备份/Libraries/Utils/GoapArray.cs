namespace Goap.Utils
{
    public static class GoapArray
    {
        ...
        public static T GetRandom<T>(ref T[] aSource)
        {
            ...
            if (aSource.Length > 0)
            {
                result = aSource[GoapMath.RandomRangeInt(0, aSource.Length - 1)];
            }
            return result;
        }
        ...
        public static T PopRandom<T>(ref T[] aSource)
        {
            ...
            if (aSource.Length > 0)
            {
                int i = GoapMath.RandomRangeInt(0, aSource.Length - 1);
                result = aSource[i];
        ...
        public static void Shuffle<T>(ref T[] aList)
        {
            ...
            {
                index--;
                newPos = GoapMath.RandomRangeInt(0, index);
                temp = aList[newPos];
